...
namespace UnityEngine
{
	...
	public static class ColorHSV
	{
		...
		public static float HueRangeMax = 360.0f;
		public static float HueRangeMin = 0.0f;
		
		public static float SaturationRangeMax = 1.0f;
		public static float SaturationRangeMin = 0.0f;
		
		public static float ValueRangeMax = 1.0f;
		public static float ValueRangeMin = 0.0f;
	...
	{
		public static float[] RGBtoHSB(int r, int g, int b, ref float[] hsb) {
			if( hsb == null ) {
				hsb = new float[3];
			}
			Color c = new Color((float)r/255.0f,(float)g/255.0f,(float)b/255.0f);
			hsb[0] = (float) c.h() / 360.0f;
			hsb[1] = (float) c.s() / 255.0f;
			hsb[2] = (float) c.v() / 255.0f;
