...
namespace processing.core
{
	...
	/// </summary>
	public sealed class PMatrix3D : PMatrix //, PConstants
	{
...
//				v2 /= norm;
		...
		{
			apply (source.m00, source.m01, source.m02, source.m03, source.m10, source.m11, source.m12, source.m13, source.m20, source.m21, source.m22, source.m23, source.m30, source.m31, source.m32, source.m33);
		}
	  ...
	  */
		...
		public float[] mult (float[] source, float[] target)
		{
			...
			if (source == target) {
				throw new Exception ("The source and target vectors used in " + "PMatrix3D.mult() cannot be identical.");
			}
			if (target.Length == 3) {
		...
		/// <summary>
		/// Calculate the determinant of a 3x3 matrix. </summary>
		...
		private void invTranslate (float tx, float ty, float tz)
		{
			preApply (1, 0, 0, -tx, 0, 1, 0, -ty, 0, 0, 1, -tz, 0, 0, 0, 1);
		}

		private void invRotateX (float angle)
		{
			float c = cos (-angle);
			float s = sin (-angle);
		...
		private void invRotateY (float angle)
		{
			float c = cos (-angle);
			float s = sin (-angle);
		...
		private void invRotateZ (float angle)
		{
			float c = cos (-angle);
			float s = sin (-angle);
		...
		private void invRotate (float angle, float v0, float v1, float v2)
		{
		...
		private void invScale (float x, float y, float z)
		{
			preApply (1 / x, 0, 0, 0, 0, 1 / y, 0, 0, 0, 0, 1 / z, 0, 0, 0, 0, 1);
		}

		private bool invApply (float n00, float n01, float n02, float n03, float n10, float n11, float n12, float n13, float n20, float n21, float n22, float n23, float n30, float n31, float n32, float n33)
		{
			if (inverseCopy == null) {
		...
		*/
			...
			// TODO: PApplet
//			Console.WriteLine (PApplet.nfs (m00, digits, 4) + " " + PApplet.nfs (m01, digits, 4) + " " + PApplet.nfs (m02, digits, 4) + " " + PApplet.nfs (m03, digits, 4));
//
//			Console.WriteLine (PApplet.nfs (m10, digits, 4) + " " + PApplet.nfs (m11, digits, 4) + " " + PApplet.nfs (m12, digits, 4) + " " + PApplet.nfs (m13, digits, 4));
//
//			Console.WriteLine (PApplet.nfs (m20, digits, 4) + " " + PApplet.nfs (m21, digits, 4) + " " + PApplet.nfs (m22, digits, 4) + " " + PApplet.nfs (m23, digits, 4));
//
//			Console.WriteLine (PApplet.nfs (m30, digits, 4) + " " + PApplet.nfs (m31, digits, 4) + " " + PApplet.nfs (m32, digits, 4) + " " + PApplet.nfs (m33, digits, 4));
